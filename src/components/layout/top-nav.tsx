    ...
    <header className="sticky top-0 z-40">
      <div
        className={cn(
          ...
          scrolled
            ? "md:mt-3 md:max-w-[1280px] md:rounded-xl md:border md:border-[var(--border-subtle)] md:bg-[color:var(--bg-canvas)]/92 md:shadow-[var(--shadow-sm)] md:backdrop-blur"
            : "border-b border-[var(--border-subtle)] bg-[color:var(--bg-canvas)]/90 backdrop-blur",
        )}
      >
        <div
          className={cn(
            "mx-auto flex h-14 w-full max-w-[1440px] items-center justify-between gap-4 px-4 transition-all duration-300 ease-out",
            scrolled ? "md:h-12 md:px-4 lg:px-6" : "md:px-6 lg:px-8",
          )}
        >
